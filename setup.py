...
import setuptools
from growabone import meta

# ....................{ METADATA ~ seo                    }....................
#FIXME: Add one or more PyPI-recognized keywords *BEFORE* pushing the first
...
_CLASSIFIERS = [
    #FIXME: Replace with alpha or beta label.
    ...
    #FIXME: Replace with PyPI-recognized classifiers.
...
_SETUP_OPTIONS = {
    ...
    'project_urls': {
        ...
        # 'Documentation': 'https://growabone.readthedocs.io',
    },
    ...
    # "sudo pip3 install growabone[all]", installing both the package and all
