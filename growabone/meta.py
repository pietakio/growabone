...
# See the "ionspire.__init__" submodule for further commentary.
...
# * The "conda/env_dev.yml" file replicating this dependency in an
#   [Ana|Mini]conda-specific manner.
# * Continuous integration test matrices, including:
#   * The top-level "tox.ini" file.
#   * The GitHub CI-specific ".gitlab-ci.yml" file.
...
# ....................{ METADATA ~ synopsis               }....................
SYNOPSIS = (
    'Electrochemical flux and field solver for modelling '
    'batteries, fuel cells, solar fuels, and bioelectrical dynamics.'
)
'''
...
COPYRIGHT = '2021 Alexis Pietak & Cecil Curry'
'''
...
# ....................{ METADATA ~ urls                   }....................
URL_HOMEPAGE = 'https://gitlab.com/pietakio/growabone'
'''
...
#   "conda/development/environment_funcs.zsh" file.
#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# WARNING: *AVOID ADDING GPL-LICENSED DEPENDENCIES.* Web backends are
...
LIBS_RUNTIME_MANDATORY = (
    ...
    # * beartype >= 0.8.1, which resolved a significant issue in beartype
    #   0.8.0, which first published support for "numpy.typing.NDArray".
    'beartype >=0.8.1',
...
#FIXME: Emit non-fatal warnings on startup for each of these optional
#depencies that is not importable.
LIBS_RUNTIME_OPTIONAL = (
    # Optional Numba dependencies recommended for improved JIT performance.
    # 'icc-rt >=2020.0.133',
)
'''
