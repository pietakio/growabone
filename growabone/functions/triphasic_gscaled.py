...
Scaling of the Gaussians leads to a much more neat and tidy final growth curve; however, it makes
working with 'time scaling' more difficult.
...
def growth_fboost(Ao, alpha, Bo, Co):

    Fboost = (Ao/alpha) + 2*Bo + 2*Co
